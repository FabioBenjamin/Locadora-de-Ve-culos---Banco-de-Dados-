CREATE TABLE Adicionais (
    Nome_Adicionais int NOT NULL UNIQUE,
...
CREATE TABLE Historico_Km (
    Km_Registardo decimal NOT NULL,
    id_Km int PRIMARY KEY NOT NULL auto_increment,
    Data_Registro decimal NOT NULL 
);

CREATE TABLE Locacao_Seguro_ (
    Agencia_Retirada varchar(255) NOT NULL,
...
CREATE TABLE Veiculo (
    ...
    Frota int NOT NULL,
    Km_Rodado decimal(5,2) NOT NULL,
